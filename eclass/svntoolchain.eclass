...
svntoolchain_pkg_setup() {
	gcc_pkg_setup
}
toolchain_src_unpack() {
	gcc_src_unpack
}
svntoolchain_src_compile() {
	gcc_src_compile
}
svntoolchain_src_test() {
	gcc_src_test
}
svntoolchain_pkg_preinst() {
	${ETYPE}_pkg_preinst
}
svntoolchain_src_install() {
	${ETYPE}_src_install
}
svntoolchain_pkg_postinst() {
	${ETYPE}_pkg_postinst
}
svntoolchain_pkg_prerm() {
	${ETYPE}_pkg_prerm
}
svntoolchain_pkg_postrm() {
	${ETYPE}_pkg_postrm
}
#----<< eclass stuff >>----
